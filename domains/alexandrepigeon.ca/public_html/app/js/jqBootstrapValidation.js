        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Votre adresse de courriel n'est pas valide !<!-- data-validator-validemail-message to override -->";
      ...
      ajax: {
		...
		builtInValidators: {
			...
			validemail: {
				...
				message: "Adresse de courriel non valide!<!-- data-validator-validemail-message to override -->"
			},
			passwordagain: {
				name: "Passwordagain",
				type: "match",
